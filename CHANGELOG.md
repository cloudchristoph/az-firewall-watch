...
- 729 tests (583 in 0.5.1); every new fact has tests for the field being present, absent and unreadable, and the explicit-proxy and TLS-inspection cases are modelled on the lab's real records.
